...
class Appeal implements AppealInterface
{
    ...
    {
        return EellyClient::request('store/appeal', __FUNCTION__, true, $appealId, $user);
    }
    ...
    {
        return EellyClient::request('store/appeal', __FUNCTION__, true, $storeId, $dimension, $status, $page, $user);
    }
