...
class RechargeRel implements RechargeRelInterface
{
    ...
    {
        return EellyClient::request('pay/rechargeRel', 'getRechargeRelByBillNo', true, $billNo);
    }
     ...
     * @since 2018年10月23日
     */
    public function getRechargeRelByBillNoAsync(string $billNo)
    {
        return EellyClient::request('pay/rechargeRel', 'getRechargeRelByBillNo', false, $billNo);
    }
