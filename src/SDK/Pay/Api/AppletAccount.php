...
class AppletAccount implements AppletAccountInterface
{
    ...
    {
        return EellyClient::request('pay/appletAccount', 'statistics', true, $storeId);
    }
     ...
     * @author wechan
     */
    public function statisticsAsync(int $storeId)
    {
        return EellyClient::request('pay/appletAccount', 'statistics', false, $storeId);
    }
    ...
    {
        return EellyClient::request('pay/appletAccount', 'myBindBanks', true, $uidDTO);
    }
     ...
     * @author hehui<hehui@eelly.net>
     */
    public function myBindBanksAsync(UidDTO $uidDTO = null)
    {
        return EellyClient::request('pay/appletAccount', 'myBindBanks', false, $uidDTO);
    }
