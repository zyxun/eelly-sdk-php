...
class Statistics implements StatisticsInterface
{
    ...
    {
        return EellyClient::request('contact/statistics', 'getStatistics', true, $contactId);
    }
    ...
    {
        return EellyClient::request('contact/statistics', 'updateStatistics', true, $contactId, $data);
    }
