...
class Black implements BlackInterface
{
    ...
    {
        return EellyClient::request('contact/black', 'getBlackCount', true, $fromType, $user);
    }
    ...
    {
        return EellyClient::request('contact/black', 'getBlack', true, $source, $user);
    }
    ...
    {
        return EellyClient::request('contact/black', 'addBlack', true, $data, $user);
    }
    ...
    {
        return EellyClient::request('contact/black', 'delete',true, $cbIds, $user);
    }
