...
use Eelly\SDK\Elastic\Service\OrderInterface;
...
class Order implements OrderInterface
{
    ...
    {
        return EellyClient::request('elastic/order', __FUNCTION__, true, $param);
    }
     ...
     * @since 2017-10-10
     */
    public function searchOrderAsync(array $param = null)
    {
        return EellyClient::request('elastic/order', __FUNCTION__, false, $param);
    }
    ...
    {
        return EellyClient::request('elastic/order', __FUNCTION__, true, $orders);
    }
     ...
     * @since 2017-10-10
     */
    public function putOrderAsync(array $orders)
    {
        return EellyClient::request('elastic/order', __FUNCTION__, false, $orders);
    }
    ...
    {
        return EellyClient::request('elastic/order', __FUNCTION__, true);
    }
     ...
     * @since 2017-10-09
     */
    public function createOrderTypeAsync()
    {
        return EellyClient::request('elastic/order', __FUNCTION__, false);
    }
    ...
    {
        return EellyClient::request('elastic/order', __FUNCTION__, true, $orderIds);
    }
     ...
     * @since 2017-10-10
     */
    public function deleteOrderAsync(array $orderIds)
    {
        return EellyClient::request('elastic/order', __FUNCTION__, false, $orderIds);
    }
     ...
     * @since 2017-10-10
     */
    public function clearOrderAsync()
    {
        return EellyClient::request('elastic/order', __FUNCTION__, false);
    }
    ...
    {
        return EellyClient::request('elastic/order', __FUNCTION__, true, $docs);
    }
     ...
     * @since 2017-10-10
     */
    public function updateOrderAsync(array $docs)
    {
        return EellyClient::request('elastic/order', __FUNCTION__, false, $docs);
    }
     ...
     * @since 2017-10-10
     */
    public function initOrderAsync()
    {
        return EellyClient::request('elastic/order', __FUNCTION__, false);
    }
