...
use Eelly\SDK\Elastic\Service\StoreInterface;
...
class Store implements StoreInterface
{
    ...
    {
        return EellyClient::request('elastic/store', __FUNCTION__, true, $stores);
    }
     ...
     * @since 2017-10-10
     */
    public function putStoreAsync(array $stores)
    {
        return EellyClient::request('elastic/store', __FUNCTION__, false, $stores);
    }
    ...
    {
        return EellyClient::request('elastic/store', __FUNCTION__, true);
    }
     ...
     * @since 2017-10-09
     */
    public function createStoreTypeAsync()
    {
        return EellyClient::request('elastic/store', __FUNCTION__, false);
    }
    ...
    {
        return EellyClient::request('elastic/store', __FUNCTION__, true, $storeIds);
    }
     ...
     * @since 2017-10-10
     */
    public function deleteStoreAsync(array $storeIds)
    {
        return EellyClient::request('elastic/store', __FUNCTION__, false, $storeIds);
    }
     ...
     * @since 2017-10-10
     */
    public function clearStoreAsync()
    {
        return EellyClient::request('elastic/store', __FUNCTION__, false);
    }
    ...
    {
        return EellyClient::request('elastic/store', __FUNCTION__, true, $docs);
    }
     ...
     * @since 2017-10-10
     */
    public function updateStoreAsync(array $docs)
    {
        return EellyClient::request('elastic/store', __FUNCTION__, false, $docs);
    }
     ...
     * @since 2017-10-10
     */
    public function initStoreAsync()
    {
        return EellyClient::request('elastic/store', __FUNCTION__, false);
    }
