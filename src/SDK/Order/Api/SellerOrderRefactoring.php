...
class SellerOrderRefactoring implements SellerOrderRefactoringInterface
{
    ...
    {
        return EellyClient::request('order/sellerOrderRefactoring', __FUNCTION__, true, $keywords, $tab, $page, $limit, $uidDTO);
    }

    /**
     * @inheritdoc
     */
    public function searchWaybillOrdersAsync(string $keywords = '', int $tab = 0, int $page = 1, int $limit = 20, UidDTO $uidDTO = null): array
    {
        return EellyClient::request('order/sellerOrderRefactoring', __FUNCTION__, false, $keywords, $tab, $page, $limit, $uidDTO);
    }
