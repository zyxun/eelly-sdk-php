...
class SellerOrder implements SellerOrderInterface
{
    ...
    {
        return EellyClient::request('order/sellerOrder', 'changeAppletOrderPrice', true, $orderId, $price, $uidDTO);
    }
     ...
     * @since 2018年05月04日
     */
    public function changeAppletOrderPriceAsync(int $orderId, int $price, UidDTO $uidDTO = null)
    {
        return EellyClient::request('order/sellerOrder', 'changeAppletOrderPrice', false, $orderId, $price, $uidDTO);
    }
