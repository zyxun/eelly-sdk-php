...
use Eelly\SDK\Order\Service\BuyerRefundInterface;
 ...
 */
class BuyerRefund implements BuyerRefundInterface
{
    /**
     * 未发货申请退款
     *
    ...
    {
        return EellyClient::request('order/buyerRefund', 'requestReturnAmount', true, $params, $orderId, $user);
    }
     ...
     * @since 2018.9.18
     */
    public function requestReturnAmountAsync(array $params, int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'requestReturnAmount', false, $params, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'requestReturnAmountEdit', true, $params, $orderId, $user);
    }
     ...
     * @since 2018.9.13
     */
    public function requestReturnAmountEditAsync(array $params, int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'requestReturnAmountEdit', false, $params, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'requestRefund', true, $params, $orderId, $user);
    }
     ...
     * @since 2018.9.13
     */
    public function requestRefundAsync(array $params, int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'requestRefund', false, $params, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'requestRefundEdit', true, $params, $orderId, $user);
    }
     ...
     * @since 2018.9.14
     */
    public function requestRefundEditAsync(array $params, int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'requestRefundEdit', false, $params, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'prepareOrderRefund', true, $orderId, $phase, $user);
    }
     ...
     * @since 2018.9.13
     */
    public function prepareOrderRefundAsync(int $orderId, int $phase, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'prepareOrderRefund', false, $orderId, $phase, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'orderRefundDetail', true, $orderId, $user);
    }
     ...
     * @since 2018.9.13
     */
    public function orderRefundDetailAsync(int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'orderRefundDetail', false, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'orderRefundEdit', true, $orderId, $user);
    }
     ...
     * @since 2018.9.17
     */
    public function orderRefundEditAsync(int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'orderRefundEdit', false, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'undoOrderRefund', true, $orderId, $user);
    }
     ...
     * @since 2018.9.13
     */
    public function undoOrderRefundAsync(int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'undoOrderRefund', false, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'orderRefundLog', true, $orderId, $user);
    }
     ...
     * @since 2018.9.13
     */
    public function orderRefundLogAsync(int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'orderRefundLog', false, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'prepareOrderRefundInvoice', true, $orderId, $user);
    }
     ...
     * @since 2018.9.17
     */
    public function prepareOrderRefundInvoiceAsync(int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'prepareOrderRefundInvoice', false, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'orderRefundInvoice', true, $params, $orderId, $user);
    }
     ...
     * @since 2018.9.13
     */
    public function orderRefundInvoiceAsync(array $params, int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'orderRefundInvoice', false, $params, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'getOrderRefundInvoice', true, $orderId, $user);
    }
     ...
     * @since 2018.9.18
     */
    public function getOrderRefundInvoiceAsync(int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'getOrderRefundInvoice', false, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'updateOrderRefundInvoice', true, $params, $orderId, $oiId, $user);
    }
     ...
     * @since 2018.9.18
     */
    public function updateOrderRefundInvoiceAsync(array $params, int $orderId, int $oiId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'updateOrderRefundInvoice', false, $params, $orderId, $oiId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'requestOrderArbitrate', true, $params, $orderId, $user);
    }
     ...
     * @since 2018.9.18
     */
    public function requestOrderArbitrateAsync(array $params, int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'requestOrderArbitrate', false, $params, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'cancelOrderArbitrate', true, $orderId, $user);
    }
     ...
     * @since 2018.9.18
     */
    public function cancelOrderArbitrateAsync(int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'cancelOrderArbitrate', false, $orderId, $user);
    }
    ...
    {
        return EellyClient::request('order/buyerRefund', 'getOrderArbitrate', true, $orderId, $user);
    }
     ...
     * @since 2018.9.18
     */
    public function getOrderArbitrateAsync(int $orderId, UidDTO $user = null)
    {
        return EellyClient::request('order/buyerRefund', 'getOrderArbitrate', false, $orderId, $user);
    }
