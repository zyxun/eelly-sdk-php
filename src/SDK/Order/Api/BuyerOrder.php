...
class BuyerOrder implements BuyerOrderInterface
{
    ...
    {
        return EellyClient::request('order/buyerOrder', __FUNCTION__, true, $tab, $page, $limit, $uidDTO);
    }
    ...
    {
        return EellyClient::request('order/buyerOrder', __FUNCTION__, true, $uidDTO);
    }
    ...
    {
        return EellyClient::request('order/buyerOrder', __FUNCTION__, true, $orderId, $uidDTO);
    }
