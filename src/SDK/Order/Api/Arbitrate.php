...
class Arbitrate implements ArbitrateInterface
{
    ...
    {
        return EellyClient::request('order/arbitrate', __FUNCTION__, true, $data);
    }

    /**
     * @inheritdoc
     */
    public function addOrderArbitrateAsync(array $data):bool
    {
        return EellyClient::request('order/arbitrate', __FUNCTION__, false, $data);
    }
