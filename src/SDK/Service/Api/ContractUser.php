...
class ContractUser implements ContractUserInterface
{
    ...
    {
        return EellyClient::request('service/contractUser', __FUNCTION__, true, $scuId, $user);
    }
     ...
     * @since 2017-09-09
     */
    public function getContractUserAsync(int $scuId, UidDTO $user = null)
    {
        return EellyClient::request('service/contractUser', __FUNCTION__, false, $scuId, $user);
    }
    ...
    {
        return EellyClient::request('service/contractUser', __FUNCTION__, true, $data, $user);
    }
     ...
     * @since 2017-09-09
     */
    public function addContractUserAsync(array $data, UidDTO $user = null)
    {
        return EellyClient::request('service/contractUser', __FUNCTION__, false, $data, $user);
    }
    ...
    {
        return EellyClient::request('service/contractUser', __FUNCTION__, true, $scuId, $data, $user);
    }
     ...
     * @since 2017-09-09
     */
    public function updateContractUserAsync(int $scuId, array $data, UidDTO $user = null)
    {
        return EellyClient::request('service/contractUser', __FUNCTION__, false, $scuId, $data, $user);
    }
    ...
    {
        return EellyClient::request('service/contractUser', __FUNCTION__, true, $condition, $currentPage, $limit, $user);
    }
     ...
     * )
     */
    public function listContractUserPageAsync(array $condition = [], int $currentPage = 1, int $limit = 10, UidDTO $user = null)
    {
        return EellyClient::request('service/contractUser', __FUNCTION__, false, $condition, $currentPage, $limit, $user);
    }
