...
class Lists
{
    ...
    {
        return EellyClient::request('service/lists', __FUNCTION__, true, $slId);
    }
     ...
     * @since 2017-09-22
     */
    public function getListsAsync(int $slId)
    {
        return EellyClient::request('service/lists', __FUNCTION__, false, $slId);
    }
    ...
    {
        return EellyClient::request('service/lists', __FUNCTION__, true, $data, $user);
    }
     ...
     * @since 2017-09-22
     */
    public function addListsAsync(array $data, UidDTO $user = null)
    {
        return EellyClient::request('service/lists', __FUNCTION__, false, $data, $user);
    }
    ...
    {
        return EellyClient::request('service/lists', __FUNCTION__, true, $slId, $data, $user);
    }
     ...
     * @since 2017-09-22
     */
    public function updateListsAsync(int $slId, array $data, UidDTO $user = null)
    {
        return EellyClient::request('service/lists', __FUNCTION__, false, $slId, $data, $user);
    }
    ...
    {
        return EellyClient::request('service/lists', __FUNCTION__, true, $slId, $user);
    }
     ...
     * @since 2017-09-22
     */
    public function deleteListsAsync(int $slId, UidDTO $user = null)
    {
        return EellyClient::request('service/lists', __FUNCTION__, false, $slId, $user);
    }
    ...
    {
        return EellyClient::request('service/lists', __FUNCTION__, true, $condition, $currentPage, $limit);
    }
     ...
     * @since 2017-09-22
     */
    public function listListsPageAsync(array $condition = [], int $currentPage = 1, int $limit = 10)
    {
        return EellyClient::request('service/lists', __FUNCTION__, false, $condition, $currentPage, $limit);
    }
