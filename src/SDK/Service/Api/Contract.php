...
class Contract
{
    ...
    {
        return EellyClient::request('service/contract', __FUNCTION__, true, $scId);
    }
     ...
     * @since 2017-09-08
     */
    public function getContractAsync(int $scId)
    {
        return EellyClient::request('service/contract', __FUNCTION__, false, $scId);
    }
    ...
    {
        return EellyClient::request('service/contract', __FUNCTION__, true, $data, $user);
    }
     ...
     * @since 2017-09-08
     */
    public function addContractAsync(array $data, UidDTO $user = null)
    {
        return EellyClient::request('service/contract', __FUNCTION__, false, $data, $user);
    }
    ...
    {
        return EellyClient::request('service/contract', __FUNCTION__, true, $scId, $data, $user);
    }
     ...
     * @since 2017-09-08
     */
    public function updateContractAsync(int $scId, array $data, UidDTO $user = null)
    {
        return EellyClient::request('service/contract', __FUNCTION__, false, $scId, $data, $user);
    }
    ...
    {
        return EellyClient::request('service/contract', __FUNCTION__, true, $condition, $currentPage, $limit);
    }
     ...
     * @since 2017-09-08
     */
    public function listContractPageAsync(array $condition = [], int $currentPage = 1, int $limit = 10)
    {
        return EellyClient::request('service/contract', __FUNCTION__, false, $condition, $currentPage, $limit);
    }
    ...
    {
        return EellyClient::request('service/contract', __FUNCTION__, true, $scId, $status, $user);
    }
     ...
     * @since 2017-09-08
     */
    public function changeContractStatusAsync(int $scId, int $status, UidDTO $user = null)
    {
        return EellyClient::request('service/contract', __FUNCTION__, false, $scId, $status, $user);
    }
