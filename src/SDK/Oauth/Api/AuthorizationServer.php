...
class AuthorizationServer implements AuthorizationServerInterface
{
    ...
    {
        return EellyClient::request('oauth/authorizationServer', __FUNCTION__, true);
    }
     ...
     * @author hehui<hehui@eelly.net>
     */
    public function accessTokenAsync()
    {
        return EellyClient::request('oauth/authorizationServer', __FUNCTION__, false);
    }
