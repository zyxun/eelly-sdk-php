...
class Client implements ClientInterface
{
    ...
    {
        return EellyClient::request('oauth/client', __FUNCTION__, true, $data);
    }
     ...
     * @author liangxinyi<liangxinyi@eelly.net>
     */
    public function addClientAsync(array $data)
    {
        return EellyClient::request('oauth/client', __FUNCTION__, false, $data);
    }
    ...
    {
        return EellyClient::request('oauth/client', __FUNCTION__, true, $clientKey, $currentPage, $limit);
    }
     ...
     * @author liangxinyi<liangxinyi@eelly.net>
     */
    public function listClientPageAsync(string $clientKey = null, int $currentPage = 1, int $limit = 10)
    {
        return EellyClient::request('oauth/client', __FUNCTION__, false, $clientKey, $currentPage, $limit);
    }
    ...
    {
        return EellyClient::request('oauth/client', __FUNCTION__, true, $clientKey);
    }
     ...
     * @author liangxinyi<liangxinyi@eelly.net>
     */
    public function listClientAsync(string $clientKey = null)
    {
        return EellyClient::request('oauth/client', __FUNCTION__, false, $clientKey);
    }
    ...
    {
        return EellyClient::request('oauth/client', __FUNCTION__, true, $clientId, $data);
    }
     ...
     * @author liangxinyi<liangxinyi@eelly.net>
     */
    public function updateClientAsync(int $clientId, array $data)
    {
        return EellyClient::request('oauth/client', __FUNCTION__, false, $clientId, $data);
    }
    ...
    {
        return EellyClient::request('oauth/client', __FUNCTION__, true, $clientId);
    }
     ...
     * since 2017-7-24
     */
    public function getClientAsync(int $clientId)
    {
        return EellyClient::request('oauth/client', __FUNCTION__, false, $clientId);
    }
     ...
     * @since 2017-7-24
     */
    public function deleteClientAsync(int $clientId)
    {
        return EellyClient::request('oauth/client', __FUNCTION__, false, $clientId);
    }
    ...
    {
        return EellyClient::request('oauth/client', __FUNCTION__, true, $clientIds);
    }
     ...
     * @since 2017-7-24
     */
    public function deleteClientBatchAsync(array $clientIds)
    {
        return EellyClient::request('oauth/client', __FUNCTION__, false, $clientIds);
    }
