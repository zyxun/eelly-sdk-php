...
class CategoryCustom
{
    ...
    {
        return EellyClient::request('goods/categoryCustom', __FUNCTION__, true, $data, $user);
    }
    ...
    {
        return EellyClient::request('goods/categoryCustom', __FUNCTION__, false, $data, $user);
    }
    ...
    {
        return EellyClient::request('goods/categoryCustom', __FUNCTION__, true, $categoryId, $user);
    }
     ...
     * )
     */
    public function getCategoryAsync(int $categoryId, UidDTO $user = null)
    {
        return EellyClient::request('goods/categoryCustom', __FUNCTION__, false, $categoryId, $user);
    }
    ...
    {
        return EellyClient::request('goods/categoryCustom', __FUNCTION__, true, $categoryId, $data, $user);
    }
    ...
    {
        return EellyClient::request('goods/categoryCustom', __FUNCTION__, false, $categoryId, $data, $user);
    }
    ...
    {
        return EellyClient::request('goods/categoryCustom', __FUNCTION__, true, $storeId, $currentPage, $limit, $user);
    }
     ...
     * )
     */
    public function listCategoryPageAsync(int $storeId, int $currentPage = 1, int $limit = 10, UidDTO $user = null)
    {
        return EellyClient::request('goods/categoryCustom', __FUNCTION__, false, $storeId, $currentPage, $limit, $user);
    }
