...
class Goods implements GoodsInterface
{
    ...
    {
        return EellyClient::request('goods/goods', 'checkOrderGoodsInfo', $goodsInfo, $returnCheckInfo);
    }
    ...
    {
        return EellyClient::request('goods/goods', 'calculateThePostage', $goodsInfo);
    }
