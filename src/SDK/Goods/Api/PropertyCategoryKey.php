...
class PropertyCategoryKey implements PropertyCategoryKeyInterface
{
    ...
    {
        return EellyClient::request('goods/propertycategorykey', 'addCategoryKey', $categoryKeyData);
    }
    ...
    {
        return EellyClient::request('goods/propertycategorykey', 'updateCategoryKey', $categoryKeyData);
    }
    ...
    {
        return EellyClient::request('goods/propertycategorykey', 'deleteCategoryKey', $categoryKeyId);
    }
    ...
    {
        return EellyClient::request('goods/propertycategorykey', 'getCategoryKey', $cateId, $isHidden);
    }
