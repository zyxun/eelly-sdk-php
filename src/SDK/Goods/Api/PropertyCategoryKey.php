...
use Eelly\SDK\Goods\Service\PropertyCategoryKeyInterface;
...
class PropertyCategoryKey
{
    ...
    {
        return EellyClient::request('goods/propertyCategoryKey', __FUNCTION__, true, $categoryKeyData);
    }
     ...
     * @since 2017年9月25日
     */
    public function addCategoryKeyAsync(array $categoryKeyData)
    {
        return EellyClient::request('goods/propertyCategoryKey', __FUNCTION__, false, $categoryKeyData);
    }
     ...
     * @since 2017年9月25日
     */
    public function updateCategoryKeyAsync(array $categoryKeyData)
    {
        return EellyClient::request('goods/propertyCategoryKey', __FUNCTION__, false, $categoryKeyData);
    }
    ...
    {
        return EellyClient::request('goods/propertyCategoryKey', __FUNCTION__, true, $categoryKeyId);
    }
     ...
     * @since 2017年9月25日
     */
    public function deleteCategoryKeyAsync(int $categoryKeyId)
    {
        return EellyClient::request('goods/propertyCategoryKey', __FUNCTION__, false, $categoryKeyId);
    }
    ...
    {
        return EellyClient::request('goods/propertyCategoryKey', __FUNCTION__, true, $cateId, $isHidden);
    }
     ...
     * @since 2017年9月25日
     */
    public function getCategoryKeyAsync(int $cateId, int $isHidden = 0)
    {
        return EellyClient::request('goods/propertyCategoryKey', __FUNCTION__, false, $cateId, $isHidden);
    }
