...
class GroupChat
{
    ...
    {
        return EellyClient::request('tim/groupChat', 'createGroup', true, $ownerAccount, $type, $name, $memberList, $extend);
    }
     ...
     * @see https://cloud.tencent.com/document/product/269/1615
     */
    public function createGroupAsync(string $ownerAccount, string $type, string $name, array $memberList = [], array $extend = [])
    {
        return EellyClient::request('tim/groupChat', 'createGroup', false, $ownerAccount, $type, $name, $memberList, $extend);
    }
    ...
    {
        return EellyClient::request('tim/groupChat', 'addGroupMember', true, $groupId, $memberList, $silence);
    }
     ...
     * @see https://cloud.tencent.com/document/product/269/1621
     */
    public function addGroupMemberAsync(string $groupId, array $memberList, int $silence = 0)
    {
        return EellyClient::request('tim/groupChat', 'addGroupMember', false, $groupId, $memberList, $silence);
    }
    ...
    {
        return EellyClient::request('tim/groupChat', 'deleteGroupMember', true, $groupId, $memberList, $silence, $reason);
    }
     ...
     * @see https://cloud.tencent.com/document/product/269/1622
     */
    public function deleteGroupMemberAsync(string $groupId, array $memberList, int $silence = 0, string $reason = '')
    {
        return EellyClient::request('tim/groupChat', 'deleteGroupMember', false, $groupId, $memberList, $silence, $reason);
    }
    ...
    {
        return EellyClient::request('tim/groupChat', 'sendGroupMsg', true, $groupId, $extend);
    }
     ...
     * @see https://cloud.tencent.com/document/product/269/2720#814046013
     */
    public function sendGroupMsgAsync(string $groupId, array $extend)
    {
        return EellyClient::request('tim/groupChat', 'sendGroupMsg', false, $groupId, $extend);
    }
    ...
    {
        return EellyClient::request('tim/groupChat', 'getGroupInfo', true, $groupIds, $extend);
    }
     ...
     * @see https://cloud.tencent.com/document/product/269/1616
     */
    public function getGroupInfoAsync(array $groupIds, array $extend = [])
    {
        return EellyClient::request('tim/groupChat', 'getGroupInfo', false, $groupIds, $extend);
    }
    ...
    {
        return EellyClient::request('tim/groupChat', 'getGroupMemberInfo', true, $groupId, $memberInfoFilter, $memberRoleFilter, $appDefineDataFilter, $extend);
    }
     ...
     * @see https://cloud.tencent.com/document/product/269/1617
     */
    public function getGroupMemberInfoAsync(string $groupId, array $memberInfoFilter = [], array $memberRoleFilter = [], array $appDefineDataFilter = [], array $extend = [])
    {
        return EellyClient::request('tim/groupChat', 'getGroupMemberInfo', false, $groupId, $memberInfoFilter, $memberRoleFilter, $appDefineDataFilter, $extend);
    }
    ...
    {
        return EellyClient::request('tim/groupChat', 'forbidSendMsg', true, $groupId, $identifiers, $expire);
    }
     ...
     * @see https://cloud.tencent.com/document/product/269/1627
     */
    public function forbidSendMsgAsync(string $groupId, array $identifiers, int $expire = 60)
    {
        return EellyClient::request('tim/groupChat', 'forbidSendMsg', false, $groupId, $identifiers, $expire);
    }
    ...
    {
        return EellyClient::request('tim/groupChat', 'sendGroupSystemNorification', true, $groupId, $content, $extend);
    }
     ...
     * @see https://cloud.tencent.com/document/product/269/1630
     */
    public function sendGroupSystemNorificationAsync(string $groupId, string $content, array $extend = [])
    {
        return EellyClient::request('tim/groupChat', 'sendGroupSystemNorification', false, $groupId, $content, $extend);
    }
    ...
    {
        return EellyClient::request('tim/groupChat', 'groupMsgGetSimple', true, $groupId, $limit, $extend);
    }
     ...
     * @see https://cloud.tencent.com/document/product/269/2738
     */
    public function groupMsgGetSimpleAsync(string $groupId, int $limit = 10, array $extend = [])
    {
        return EellyClient::request('tim/groupChat', 'groupMsgGetSimple', false, $groupId, $limit, $extend);
    }
    ...
    {
        return EellyClient::request('tim/groupChat', 'destroyGroup', true, $groupId);
    }
     ...
     * @see https://cloud.tencent.com/document/product/269/1624
     */
    public function destroyGroupAsync(string $groupId)
    {
        return EellyClient::request('tim/groupChat', 'destroyGroup', false, $groupId);
    }
