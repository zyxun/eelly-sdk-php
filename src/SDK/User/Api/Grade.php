...
class Grade implements GradeInterface
{
    ...
    {
        return EellyClient::request('user/grade', 'getGrade',true, $gradeId);
    }
    ...
    {
        return EellyClient::request('user/grade', 'addGrade',true, $data);
    }
    ...
    {
        return EellyClient::request('user/grade', 'updateGrade',true, $gradeId, $data);
    }
    ...
    {
        return EellyClient::request('user/grade', 'deleteGrade',true, $gradeId);
    }
    ...
    {
        return EellyClient::request('user/grade', 'listGradePage',true, $condition, $currentPage, $limit);
    }
