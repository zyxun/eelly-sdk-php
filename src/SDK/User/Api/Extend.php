...
class Extend implements ExtendInterface
{
    ...
    {
        return EellyClient::request('user/extend', 'getExtend',true, $userId);
    }
    ...
    {
        return EellyClient::request('user/extend', 'addExtend', true,$data);
    }
    ...
    {
        return EellyClient::request('user/extend', 'updateExtend',true, $userId, $data);
    }
    ...
    {
        return EellyClient::request('user/extend', 'listExtendPage',true, $condition, $currentPage, $limit);
    }
    ...
    {
        return EellyClient::request('user/extend', 'checkMobileIsBind', true,$mobile);
    }
    ...
    {
        return EellyClient::request('user/extend', 'getScanFlagStatus', true,$user);
    }
    ...
    {
        return EellyClient::request('user/extend', 'changeScanFlagStatus', true,$scanFlag, $user);
    }
