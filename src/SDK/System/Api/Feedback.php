...
class Feedback implements FeedbackInterface
{
    ...
    {
        return EellyClient::request('system/feedback', __FUNCTION__, true, $FeedbackId);
    }
     ...
     * @since 2017-9-2
     */
    public function getFeedbackAsync(int $FeedbackId)
    {
        return EellyClient::request('system/feedback', __FUNCTION__, false, $FeedbackId);
    }
    ...
    {
        return EellyClient::request('system/feedback', __FUNCTION__, true, $data);
    }
     ...
     * @since 2017-9-2
     */
    public function addFeedbackAsync(array $data)
    {
        return EellyClient::request('system/feedback', __FUNCTION__, false, $data);
    }
     ...
     * )
     */
    public function deleteFeedbackAsync(int $FeedbackId)
    {
        return EellyClient::request('system/feedback', __FUNCTION__, false, $FeedbackId);
    }
    ...
    {
        return EellyClient::request('system/feedback', __FUNCTION__, true, $condition, $currentPage, $limit);
    }
     ...
     * @badSql
     */
    public function listFeedbackPageAsync(array $condition = [], int $currentPage = 1, int $limit = 10)
    {
        return EellyClient::request('system/feedback', __FUNCTION__, false, $condition, $currentPage, $limit);
    }
    ...
    {
        return EellyClient::request('system/feedback', __FUNCTION__, true, $feedbackId, $operateStyle, $status, $user);
    }
     ...
     * @since  2017/9/5
     */
    public function changeStatusAsync(int $feedbackId, string $operateStyle, int $status, UserDTO $user)
    {
        return EellyClient::request('system/feedback', __FUNCTION__, false, $feedbackId, $operateStyle, $status, $user);
    }
    ...
    {
        return EellyClient::request('system/feedback', __FUNCTION__, true, $FeedbackId, $operateData, $user);
    }
     ...
     * @since 2017-9-2
     */
    public function ReplyFeedbackAsync(int $FeedbackId, array $operateData, UserDTO $user)
    {
        return EellyClient::request('system/feedback', __FUNCTION__, false, $FeedbackId, $operateData, $user);
    }
