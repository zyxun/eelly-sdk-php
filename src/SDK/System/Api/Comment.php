...
class Comment implements CommentInterface
{
    ...
    {
        return EellyClient::request('system/comment', __FUNCTION__, true, $commentId);
    }
     ...
     * @since  2017-09-27
     */
    public function getCommentAsync(int $commentId)
    {
        return EellyClient::request('system/comment', __FUNCTION__, false, $commentId);
    }
    ...
    {
        return EellyClient::request('system/comment', __FUNCTION__, true, $data, $user);
    }
     ...
     * @since  2017-09-27
     */
    public function addCommentAsync(array $data, UidDTO $user = null)
    {
        return EellyClient::request('system/comment', __FUNCTION__, false, $data, $user);
    }
    ...
    {
        return EellyClient::request('system/comment', __FUNCTION__, true, $commentId, $user);
    }
     ...
     * @since  2017-09-27
     */
    public function deleteCommentAsync(int $commentId, UidDTO $user = null)
    {
        return EellyClient::request('system/comment', __FUNCTION__, false, $commentId, $user);
    }
    ...
    {
        return EellyClient::request('system/comment', __FUNCTION__, true, $condition, $currentPage, $limit);
    }
     ...
     * @since  2017-09-27
     */
    public function listCommentPageAsync(array $condition = [], int $currentPage = 1, int $limit = 10)
    {
        return EellyClient::request('system/comment', __FUNCTION__, false, $condition, $currentPage, $limit);
    }
