...
class CommentReply implements CommentReplyInterface
{
    ...
    {
        return EellyClient::request('system/commentreply', 'getCommentReply', $scrId);
    }
    ...
    {
        return EellyClient::request('system/commentreply', 'addCommentReply', $data, $user);
    }
    ...
    {
        return EellyClient::request('system/commentreply', 'deleteCommentReply', $scrId);
    }
    ...
    {
        return EellyClient::request('system/commentreply', 'listCommentReplyPage', $condition, $currentPage, $limit);
    }
